...
const bands = [
  ...
  },
  {
    ...
    message:
      "현실의 규칙과 구조를 잘 이해하면서도, ‘이렇게만 살고 싶진 않은데’라는 감각이 함께 있습니다. 기반을 차곡차곡 쌓는 흐름입니다.",
    summary: "루틴과 기반을 차분히 쌓아가는 자리입니다.",
    scenePrompt:
      "오늘 해야 할 일들 사이에서, 잠깐이라도 ‘이 자체로 너무 즐겁다’라고 느낀 순간이 있었나요?",
    futureHint:
    ...
    actionHint:
      "오늘 해야 할 일 목록 옆에, ‘지금의 나를 미세하게 깨우는 작은 즐거움 1개’를 붙여 보세요. 예를 들면 문제집 2페이지 + 좋아하는 영상 5분 보기처럼, 두 개를 세트로 실행해 보세요."
  },
  {
    min: 41,
    max: 60,
  ...
  },
  {
    ...
    actionHint:
      "오늘 떠오른 장면·문장·아이디어 중에서 하나를 골라 5줄짜리 메모나 작은 스케치로 남겨 보세요. 그리고 옆에 ‘내일 이걸 실제로 건드려보는 작은 행동 1개’를 같이 적어 두면, 머릿속에만 있던 감각이 현실으로 넘어오기 시작합니다."
  },
  {
    min: 81,
    max: 100,
    ...
    actionHint:
      "머릿속이 너무 복잡할 때 휴대폰을 다른 방에 두고, 방 정리·빨래·설거지·쓰레기 버리기 중 하나를 골라 15분만 해 보세요. 머리는 자유롭게 상상하되, 몸은 현실 루틴에 잠깐 묶어 두는 연습이라고 생각해도 괜찮습니다."
  }
];
